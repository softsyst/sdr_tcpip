...
RTLSDR_API double atofs(char *s);
...
RTLSDR_API double atoft(char *s);
...
RTLSDR_API double atofp(char *s);
...
RTLSDR_API int nearest_gain(rtlsdr_dev_t *dev, int target_gain);
...
RTLSDR_API int verbose_set_frequency(rtlsdr_dev_t *dev, uint32_t frequency);
...
RTLSDR_API int verbose_set_sample_rate(rtlsdr_dev_t *dev, uint32_t samp_rate);
...
RTLSDR_API int verbose_direct_sampling(rtlsdr_dev_t *dev, int on);
...
RTLSDR_API int verbose_offset_tuning(rtlsdr_dev_t *dev);
...
RTLSDR_API int verbose_auto_gain(rtlsdr_dev_t *dev);
...
RTLSDR_API int verbose_gain_set(rtlsdr_dev_t *dev, int gain);
...
RTLSDR_API int verbose_ppm_set(rtlsdr_dev_t *dev, int ppm_error);
...
RTLSDR_API int verbose_reset_buffer(rtlsdr_dev_t *dev);
...
RTLSDR_API int verbose_device_search(char *s);
