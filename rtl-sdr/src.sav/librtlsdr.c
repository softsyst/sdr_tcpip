...
//#define DEFAULT_BUF_LENGTH	(64 * 32 * 512) // this setting: mem pool empty in qirx
#define DEFAULT_BUF_LENGTH	(1 * 32 * 512)
//#define DEFAULT_BUF_LENGTH	(32 * 512)
//#define DEFAULT_BUF_LENGTH	(32 * 512) //16kB = 4ms @2048000sps
